...
domestic.append(Node('TNenter', 'T North', Type.Joint))
domestic.append(Node('TN', 'T North', Type.Joint))
...
Node('TM', 'T Middle', Type.Joint)
Node('TSenter', 'T South', Type.Joint)
Node('TS', 'T South', Type.Joint)
Node('TR25', 'Shellis News', Type.Retail)
Node('TR28', 'Tech Showcase', Type.Retail)
Node('TJ11', '', Type.Joint)
Node('TG8', 'Gate T8', Type.Gate)
Node('TR21', 'Headphone Hub', Type.Retail)
Node('TR22', 'Inmotion Entertainment', Type.Retail)
Node('TJ12', '', Type.Joint)
Node('TF7', 'Sam Adams / Checkpoint Bistro', Type.Food)
Node('TJ13', '', Type.Joint)
Node('TG7', 'Gate T7', Type.Gate)
