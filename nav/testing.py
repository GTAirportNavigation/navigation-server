...
domestic.append(Node('TM', 'T Middle', Type.Joint))
domestic.append(Node('TSenter', 'T South', Type.Joint))
domestic.append(Node('TS', 'T South', Type.Joint))
domestic.append(Node('TR25', 'Shellis News', Type.Retail))
...
insert_path(domestic, 'TJ8', 'TR17', 0, EAST)
...
insert_path(domestic, 'TSenter', 'TR25', 0, NORTH)
...
insert_path(domestic, 'TJ19', 'TR17', 0, WEST)
...
insert_path(domestic, 'TJ26', 'TR25', 0, WEST)
